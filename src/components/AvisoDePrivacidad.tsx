...
const AvisoDePrivacidad = () => {
  return (
    <div className="max-w-3xl mx-auto px-4 py-10 text-gray-800">
      ...
      <p className="mb-4">
        <strong>Integralis Psicología</strong>, con domicilio en México, y representado por el Psic. Juan Perez, con cédula profesional número <strong>XXXXXXXX</strong>, es responsable del uso y protección de sus datos personales.
      </p>
      <p className="mb-4">
