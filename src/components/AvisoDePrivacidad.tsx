...
const AvisoDePrivacidad = () => {
  return (
    <div className="max-w-3xl mx-auto px-4 py-10 text-gray-800">
      ...
      <p className="mb-4">
        <strong>Creciendo Psicología</strong>, con domicilio en México, y representado por el Psic. Israel Juárez, con cédula profesional número <strong>13693414</strong>, es responsable del uso y protección de sus datos personales.
      </p>
      <p className="mb-4">
      ...
      <p className="mb-4">
        Usted tiene derecho de acceder, rectificar, cancelar u oponerse al tratamiento de sus datos personales (derechos ARCO), conforme a lo establecido en la <strong>Ley Federal de Protección de Datos Personales en Posesión de los Particulares</strong>. Para ejercer estos derechos, puede comunicarse al correo: <a href="mailto:israel.juarez.psic@gmail.com" className="text-green-700 underline">israel.juarez.psic@gmail.com</a> o al número <a href="tel:+527351965576" className="text-green-700 underline">+52 735 196 5576</a>.
      </p>
      <p className="mb-4">
